...
<body class="vide-like-body">
    <div class="vide-like-container">
        <div id="login-frame" class="frame-container vide-like-login-frame">
            <h2><?= lang('backend_section') ?></h2>
            <p class="vide-like-subtitle mb-6"><?= lang('you_need_to_login') ?></p>
            <div class="alert hidden"></div>
            <form id="login-form">
                <div class="form-group vide-like-form-group">
                    <label for="username" class=""><?= lang('username') ?></label>
                    <input type="text" id="username"
                                    placeholder="<?= lang('enter_username_here') ?>"
                                    class="form-control vide-like-input-field" />
                </div>
                <div class="form-group vide-like-form-group">
                ...
                <button type="submit" id="login" class="btn btn-primary vide-like-btn vide-like-login-btn">
                    <?= lang('login') ?>
                </button>
                ...
                <!--|-->
                <span id="select-language" class="label label-success gone">
