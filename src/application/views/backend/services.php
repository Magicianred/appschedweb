...
<script>
    var GlobalVariables = {
        ...
        max_services  : <?= json_encode($this->settings_model->get_setting('company_max_services')) ?>,
        ...
        <div role="tabpanel" class="tab-pane active" id="services">
            <div class="row">
                ...
                <div class="record-details column col-xs-12 col-sm-5">
                    ...
                    <div class="form-group hidden"><!-- appschedweb customization, hidden and value="0" -->
                        <label for="service-price"><?= lang('price') ?> *</label>
                        <input id="service-price" value="0" class="form-control" placeholder="0">
                    </div>

                    <div class="form-group hidden"><!-- appschedweb customization -->
                    ...
                    <div class="form-group hidden"><!-- appschedweb customization -->
                        ...
                        <select id="service-availabilities-type" class="form-control">
                            ...
                            <option selected value="<?= AVAILABILITIES_TYPE_FIXED ?>"><!-- appschedweb customization: selezionato fixed -->
                                <?= lang('fixed') ?>
                            </option>
                        </select>
                    </div>

                    <div class="form-group"><!-- appschedweb customization -->
                        <label for="service-vide-type"><?= lang('service_vide_type') ?></label>
                        <select id="service-vide-type" class="form-control">
                            <option value="<?= VIDE_TYPE_ACTIVE ?>">
                                <?= lang('vide_active') ?>
                            </option>
                            <option value="<?= VIDE_TYPE_NOT_ACTIVE ?>">
                                <?= lang('vide_not_active') ?>
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="service-additional-info"><?= lang('additional_info') ?></label>
                        <textarea id="service-additional-info" rows="4" class="form-control"></textarea>
                    </div>
