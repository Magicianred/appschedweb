...
<script src="<?= asset_url('assets/js/closing_days.js') ?>"></script>
<script src="<?= asset_url('assets/js/carousel.js') ?>"></script>
...
<div id="settings-page" class="container-fluid">
    <ul class="nav nav-tabs" role="tablist">
        ...
        <?php if ($privileges[PRIV_SYSTEM_SETTINGS]['view'] == TRUE): ?>
            <li role="presentation">
                <a href="#virtual-desk" aria-controls="virtual-desk" role="tab" data-toggle="tab"><?= lang('virtual_desk') ?></a>
            </li>
        <?php endif ?>
        <?php if ($privileges[PRIV_SYSTEM_SETTINGS]['view'] == TRUE): ?>
            <li role="presentation">
    ...
    <div class="tab-content">
                        ...
                        <div class="col-xs-12 col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="logo-upload-wrapper">
                                    <button type="button" id="logo-upload" class="btn btn-default" data-toggle="button">
                                        <span class="glyphicon glyphicon-upload"></span>
                                        Upload
                                    </button>
                                    <div id="logo-filename" class="upload-logo-filename"><?= lang('no_file_selected') ?></div>
                                </div>
                                <span class="help-block">
                ...
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-7 working-plan-wrapper">
                            ...
                            <h4><?= lang('closing_days') ?></h4>
                            <span class="help-block">
                                <?= lang('closing_days_hint') ?>
                            </span>
                            <div>
                                <button type="button" class="add-closing-day btn btn-primary" id="add-closing">
                                    <span class="glyphicon glyphicon-white glyphicon glyphicon-plus"></span>
                                    <?= lang('add_closing_days');?>
                                </button>
                            </div>

                            <table class="closing-days table table-striped">
                                <thead>
                                    <tr>
                                        <th><?= lang('day') ?></th>
                                        <th><?= lang('actions') ?></th>
        ...
        <?php $hidden = ($privileges[PRIV_SYSTEM_SETTINGS]['view'] == TRUE) ? '' : 'hidden' ?>
        <div role="tabpanel" class="tab-pane <?= $hidden ?>" id="virtual-desk">
            <form>
                <fieldset>
                    <legend>
                        <?= lang('virtual_desk') ?>
                    ...
                    <h4><?= lang('set_carousel_title') ?></h4>
                    <span class="help-block">
                        <?= lang('set_carousel_hint') ?>
                    </span>
                    <div>
                        <button type="button" class="add-carousel-item btn btn-primary" id="add-carousel-item">
                            <span class="glyphicon glyphicon-white glyphicon glyphicon-plus"></span>
                            <?= lang('add_carousel_item');?>
                        </button>
                    </div>

                    <br>

                    <table class="carousel-items table table-striped">
                        <thead>
                            <tr>
                                <th><?= lang('carousel_background') ?></th>
                                <th><?= lang('carousel_alt_text') ?></th>
                                <th><?= lang('carousel_link') ?></th>
                                <th><?= lang('carousel_link_text') ?></th>
                            </tr>
                        </thead>
                        <tbody><!-- Dynamic Content --></tbody>
                    </table>                   
            ...
            <input type="file" accept="image/*" class="gone" id="carousel-file-0" name="filename-0">
            <input type="file" accept="image/*" class="gone" id="carousel-file-1" name="filename-1">
            <input type="file" accept="image/*" class="gone" id="carousel-file-2" name="filename-2">
            <input type="file" accept="image/*" class="gone" id="carousel-file-3" name="filename-3">
            <input type="file" accept="image/*" class="gone" id="carousel-file-4" name="filename-4">
        </div>
        ...
        <!-- these elements are placed here to prevent the default json-encoding 
        runned by the controller. Not the cleanest solution, but works fine ;) -->
        <input id="company-logo" accept="image/*" class="gone" type="file" name="fileToUpload" id="fileToUpload">
        <div type="text"  id="logo_base64" class="form-control gone"></div>
