...
<body class="vide-like-body">
    <div id="header">                
        <?php 
            $db_logo = $this->settings_model->get_setting('company_logo');
            $company_logo = !is_null($db_logo) && isset($db_logo) && !empty($db_logo) ? 'data:'.$db_logo : null;
            $logo_class = !isset($company_logo) ? "gone" : "header-logo";
        ?>  
        <img src="<?= $company_logo ?>" id="header-logo-img" class="<?= $logo_class ?>">
    ...
    <div id="main" class="container">
            ...
            <div id="book-appointment-wizard" class="col-xs-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
                ...
                <div id="wizard-frame-1" class="wizard-frame">
                    ...
                    <div class="command-buttons">
                        <button type="button" id="button-next-1" class="btn button-next btn-primary vide-like-btn"
                                data-step_index="1">
                            <?= lang('next') ?>
                ...
                <div id="wizard-frame-2" class="wizard-frame" style="display:none;">
                    ...
                    <div class="command-buttons">
                        ...
                        <button type="button" id="button-next-2" class="btn button-next btn-primary vide-like-btn"
                                data-step_index="2">
                            <?= lang('next') ?>
                            <span class="glyphicon glyphicon-forward"></span>
                        </button>
                ...
                <div id="wizard-frame-3" class="wizard-frame" style="display:none;">
                    <div class="frame-container">
                        ...
                        <div class="frame-content row">
                            ...
                            <span id="form-message" class="text-danger col-xs-12 col-sm-6"><?= lang('fields_are_required') ?></span>
                        </div>
                    </div>
                    ...
                    <div class="command-buttons">
                        ...
                        <button type="button" id="button-next-3" class="btn button-next btn-primary vide-like-btn"
                                data-step_index="3">
                            <?= lang('next') ?>
                            <span class="glyphicon glyphicon-forward"></span>
                        </button>
                ...
                <div id="wizard-frame-4" class="wizard-frame" style="display:none;">
                    ...
                    <div class="command-buttons">
                        ...
                        <form id="book-appointment-form" style="display:inline-block" method="post">
                            <button id="book-appointment-submit" type="button" class="btn vide-like-btn">
        ...
        <div class="col-xs-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2 p-0">
            <div class="csi-logo"></div>
        </div>
    </div>
