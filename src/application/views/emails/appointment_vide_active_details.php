...
<body style="font: 13px arial, helvetica, tahoma;">
    <div class="email-container" style="width: 650px; border: 1px solid #eee;">
        <div id="header" style="background-color: #f0f3f8 ;
                height: 45px; padding: 10px 15px;">
            <strong id="logo" style="color: black; font-size: 20px;
                    margin-top: 10px; display: inline-block">$company_name</strong>
        </div>
        ...
        <div id="content" style="padding: 10px 15px;">
			...
			<br>
            <p>External Link</p> <!-- testo introduttivo al link della videoconferenza-->
            <p><a href="$ext_appointment_link" style="width: 600px;">$ext_appointment_link</a><p><!-- testo introduttivo al link della videoconferenza-->
            <p>Document Info</p> <!-- Per utilizzare questo servizio... etc -->
            <p>$additional_info</p>
            <p>Appointment Link</p> <!-- Puoi modificare o cancellare... etc -->
            <p><a href="$appointment_link" style="width: 600px;">$appointment_link</a></p>
            <p>NoReply Message</p>
        </div>
