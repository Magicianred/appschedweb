...
class Installation extends CI_Controller {
    ...
    public function ajax_install()
    {
        try
        {
            ...
            $file_contents = str_replace('{{PREFIX}}', $_ENV['PREFIX'], $file_contents);
            ...
            $this->settings_model->set_setting('company_logo', '');
            $this->settings_model->set_setting('company_closing_days', '');
            $this->settings_model->set_setting('company_vide_carousel', '{}');
            $this->settings_model->set_setting('company_max_services', '3'); // default, numero massimo di sportelli per tenant
