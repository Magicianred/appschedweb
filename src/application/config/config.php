...
$config['csi_version'] = '1.0.0'; // versione CSI Piemonte.
$config['release_label'] = ''; // Leave empty for no title or add Alpha, Beta etc ...
$config['google_sync_feature'] = FALSE;
...
|
*/
$config['encryption_key'] = $_ENV['BASE_URL'];
...
|
*/
$config['vide_api_base_url'] = $_ENV['VIDE_BASE_URL_API'] . '/videapi/api/v1/';
$config['vide_cookie'] = 'vide_auth';
$config['vide_ext_system_name'] = 'VIDE';
