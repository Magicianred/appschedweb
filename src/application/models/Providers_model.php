...
class Providers_Model extends CI_Model {
     ...
     * @throws UsernameExistsException (Appschedweb): quando si tenta di aggiungere un nome utente già presente.
     */
    ...
    public function validate($provider)
    {
        ...
        if (isset($provider['settings']['username']))
        {
            ...
            {
                throw new UsernameExistsException ('Username already exists. Please select a different '
