...
class Customers_Model extends CI_Model {
    ...
    public function exists($customer)
    {
        ...
        {
            throw new Exception(lang('customer_mail_not_provided'));
        }
    ...
    protected function _insert($customer)
    {
        ...
        {
            throw new Exception(lang('could_not_insert_customer'));
        }
    ...
    protected function _update($customer)
    {
        ...
        {
            throw new Exception(lang('could_not_update_customer'));
        }
    ...
    public function find_record_id($customer)
    {
        ...
        {
            throw new Exception(lang('customer_rec_id_notfound'));
        }
    ...
    public function validate($customer)
    {
        ...
        if ($num_rows > 0)
        {
            throw new Exception(lang('customer_mail_already_exists'));
        }
