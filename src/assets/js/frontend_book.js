...
(function (exports) {
    ...
    exports.manageMode = false; 
     ...
     /*  recupero i giorni non lavorativi dalla tabella ea_setting e li aggiungo in updatedUnavailableDays*/
     var publicHolidays;
     var updatedUnavailableDays = [];
    
     var url = GlobalVariables.baseUrl + '/index.php/Appointments/ajax_get_holidays';
    ...
    publicHolidays = JSON.parse('[' +   response.holiday_array.replace(/'/g, '"') + ']');
    ...
    var curr_year;
     ...
     function unavailable(date) {
            ...
            if ($.inArray(dmy, updatedUnavailableDays) < 0) {
    ...
    function _bindEventHandlers() {
        ...
        $('#select-service').change(function () {
            ...
            if ($('#select-provider option').length >= 1) {
                ...
                $("#select-provider option[value='any-provider']").attr("selected","selected");
            }
