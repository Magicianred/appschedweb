...
(function (exports) {
    ...
    /**
     * appschedweb customization: al caricamento della pagina dei services (sportelli)
     * si verifica se è possibile o meno aggiungerne di altri.
     */
    $( window ).on( "load", function(){
        servicesHelper.checkLimitServiceReached();
    });
