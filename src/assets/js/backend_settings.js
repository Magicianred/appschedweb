...
(function (exports) {
    ...
    /**
     * Use this ClosingDays class instance to perform actions on the page's closing days tables.
     *
     * @type {ClosingDays}
     */
    exports.cd = {};
    ...
    /**
     * Use this Carousel class instance to perform actions on the page's carousel tables.
     *
     * @type {Carousel}
     */
    exports.vc = {};
    ...
    exports.initialize = function (bindEventHandlers) {
        ...
        $.each(GlobalVariables.settings.system, function (index, setting) {
            ...
            if (setting.name === 'company_closing_days') {
                // appschedweb: get closing days from DB (string -> array)
                let days = setting.value;
                closingDays = days!==null ? setting.value.split(",") : [];
            }

            if (setting.name === 'company_vide_carousel') {
                let days = setting.value;
                carousel = days!==null ? $.parseJSON(setting.value) : {};
            }
        ...
        // appschedweb (giorni di chiusura e carousel)
        exports.cd = new ClosingDays();
        exports.cd.setup(closingDays);

        exports.vc = new Carousel();
        exports.vc.setup(carousel);
    ...
    function _bindEventHandlers() {
        ...
        exports.cd.bindEventHandlers();
        exports.vc.bindEventHandlers();
